...
\refPro{property1} reads: $\ec{Q}$ strongly simulates\footnote{Strong simulation considers $\tau$ actions as defined in \refSec{sec_pi_simulation}} $\ec{P}$ implies $\ec{P}$ refines $\ec{Q}$,i.e. $\ec{P}$ has less behavior than $\ec{Q}$, where:
