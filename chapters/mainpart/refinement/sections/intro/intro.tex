Due to performance issue, we will limit the refeimnet check to $\pi$ processes without data. Additionaly, we limit ous self to procees without the \textit{new} operator\footnote{Processes transparent to enviroment}.To study the refinement of \picalc{} processes we will use the results of the big-step trace semantics defined in \cite{gieseking}, with some simplifications. 
