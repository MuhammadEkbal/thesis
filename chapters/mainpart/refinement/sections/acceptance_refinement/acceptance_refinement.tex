...
It is clear that $Q$ strongly simulates $P$. This result implies, according to \refCor{cor_sim_acceptance_refinement}, that $P$ refines $Q$ in the success-refinement model. In other words $\forall t$ then $Y_P \subseteq Y_Q$.
