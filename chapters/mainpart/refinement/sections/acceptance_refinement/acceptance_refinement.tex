...
\label{def_failure_ref}
	Let $P,Q\in\procs$, then $P$ is a \findex[acceptance!refinement]{acceptance refinement} of $Q$ ($Q\refiF P$) iff the inverse set inclusion of traces and acceptances holds:
\begin{align}
   \ec{Q} \refiAC \ec{P} \Leftrightarrow  \traces[P]\subseteq\traces[Q] \wedge \accepatances[P]\subseteq\accepatances[Q]
\end{align}
	We also say for $Q\refiAC{}P$ that $P$ \findex[refinement]{refines} $Q$.
\end{definition}
