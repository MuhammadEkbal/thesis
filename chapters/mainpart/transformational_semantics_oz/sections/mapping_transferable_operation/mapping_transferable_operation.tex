...
Finally, \refFig{tra_system}, \refLis{tra_system_lis} shows the big picture of a system consisting of two shops, vending machine and a customer. The full implementation can be found in the appendix.
