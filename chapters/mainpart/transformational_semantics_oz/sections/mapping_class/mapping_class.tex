The class \textit{VM} shown in \refFig{tra_vm_OZ_PI} is mapped to a \picalc{} process \textit{VM\_OZ\_PI} shown in \refLis{tra_vm_OZ_listing}. The processes \textbf{VM\_OZ} has six parameters
\begin{itemize}
