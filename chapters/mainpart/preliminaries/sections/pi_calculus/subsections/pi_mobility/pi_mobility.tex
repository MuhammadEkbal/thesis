...
\refFig{pi_mobility_stargazer_code} shows the stargazer code listing of the process $\procres{x,y}{(\procpar{\proccall{A}{x,y}}{\proccall{B}{x}})}$,  \refFig{pi_mobility_stargazer_react} shows it's visualization before and after the interaction occurrence.
\begin{figure}[ht!]
