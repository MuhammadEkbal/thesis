...
To check the strong simulation we can use \findex{ABC (Another Bisimilarity Checker)} \cite{abc}. ABC is a tool that checks simulation between  \picalc{} processes. \refLis{pi_simulation_ABC_code} shows the code of the process $P$ and $Q$ in ABC syntax.
\raggedbottom
