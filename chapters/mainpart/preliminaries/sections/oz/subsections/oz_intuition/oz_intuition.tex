...
\end{figure}
Finally, we can model the $decrease\_tea$ operation schema as we did with $decrease\_coffee$ to get the class $VM$ as shown in \refFig{oz_VM_op_coffee_tea}, which represents all the specification we had of the vending machine written in \oz{} language.
